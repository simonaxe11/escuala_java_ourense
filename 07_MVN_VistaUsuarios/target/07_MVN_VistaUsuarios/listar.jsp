...
<%!ArrayList<Usuario> todosUsuarios;%><!-- Es una declaración por eso lleva la exclamacion -->
<%
	...
	<div border="2">
		...
		<form action="usuarios.do" method="post" name="form">
			<input id="id" name="id" type="text" size="4" readonly="true" value="<%= usu.getId() %>" /> 
				...
				<input id="password" name="password" type="password" required="true" value="<%= usu.getPassword() %>" /> <input class="method" id="method" name="method" type="text" size="4" readonly="true" value="PUT" /> 
